...
import { createNotesSchema, noteIdSchema, updateNoteSchema, getAllNotesSchema } from "../validations/notesValidation.js";
...
notesRoutes.post('/notes/', celebrate(createNotesSchema), createNote);
